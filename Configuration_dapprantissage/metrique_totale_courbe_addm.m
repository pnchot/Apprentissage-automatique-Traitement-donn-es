function [donnees] = etude_compliance(nbreTube,numFi,bishopf,solution,val_E1,val_E2,val_G1,val_G2,diam_Mst_outer,F,coeff_division_D2,index_longeur_tub1,bishopf_name,solution_name)
   ...
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [SomAbsTorsion,SomTorsion,to ] =  torsion_courbure(bishopf_name,solution_name);
...
%     
    ...
    k1 = E1*I1;
    k2 = E2*I2;
    donnees = [nbreTube,numFi,SomAbsTorsion,SomTorsion];
