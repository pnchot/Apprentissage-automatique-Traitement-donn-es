function mat2xlsx(Nombre_de_fichier,path)
% path =  'C:\Users\Denis\Documents\STAGE_ETUDE_COMPLIANCE\CODES\compliance_code\compliance_code\Traitements Donnees\txt_hors_plan\metrique_courbe_random_1_tube.xlsx'
% avec le nom du fichier de sortie .xlsx
clear 
close all
...
for i =1:Nombre_de_fichier % Verifier la fin de l'indice pour les essais plan ou hors plan  
            ...
            donnees = metrique_totale_courbe(num_dossier,i-1,bishopf,solution,E,0,G,0,D,F(1),coeff_division_D2(1),indx_longeur_tube1(1)); % Le changement des indexes pour faire varier soit la raideur soit les longeurs
            no_erreur = xlswrite(path,donnees,name_feuille,['A' num2str(num_ligne_fichier + i) ':AW' num2str(num_ligne_fichier+i)]); % Le dernier numero correspond au dossier plane config 
end 
end